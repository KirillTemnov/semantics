...
((exports, util) ->
  ...
  # and more
  exports.personals = personals = ["вам", "вами", "вас", "вы", "его", "ей", "ему", "ею", "её", "её", "им", "ими", "их", "мы", "нам", "нами", "нас", "него", "ней", "нему", "нею", "неё", "ним", "ними", "них", "нём", "он", "она", "оне", "они", "оно", "тебе", "тебя", "тобой", "тобою", "ты", "я"]
